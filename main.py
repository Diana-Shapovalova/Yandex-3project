...
bot = telebot.TeleBot("6153762981:AAFwvps4SlPF5C7l3JtmhkuvIxUY6lGYcAY")
cnt = 0
...
def get_text_messages(message):
    if message.text == '👋 Поздороваться':
        ...
        if x == 1:
            ...
            bot.send_audio(chat_id=message.from_user.id, audio=open("music/1.mp3", 'rb'))
            ...
            bot.send_audio(chat_id=message.from_user.id, audio=open("music/2.mp3", 'rb'))
